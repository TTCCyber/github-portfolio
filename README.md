...
I have demonstrated my technical aptitude through participation in the Telstra SOC Cybersecurity Job Simulation, where I conducted incident response and analysis of cyber-attacks, developed Python scripts for automated malware analysis, created detailed incident reports, and identified and documented Indicators of Compromise (IOCs) from security incidents. Additionally, I've built and maintained a security testing environment using virtual machines for malware analysis and threat detection.
